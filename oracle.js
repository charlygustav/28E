...
class OracleRoom {
    ...
    updateCamBtnUI() {
        ...
        if (this.cameraEnabled) {
            btn.classList.remove('muted');
            btn.innerHTML = `<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M23 7l-7 5 7 5V7z"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg><div id="cam-strike" class="scale-0"></div>`;
        } else {
            btn.classList.add('muted');
            btn.innerHTML = `<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M23 7l-7 5 7 5V7z"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg><div id="cam-strike" class="scale-100"></div>`;
        }
    }
